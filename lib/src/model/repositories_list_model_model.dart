...
RepositoriesListModel repositoriesListModelFromJson(String str) => RepositoriesListModel.fromJson(json.decode(str));

String repositoriesListModelToJson(RepositoriesListModel data) => json.encode(data.toJson());
...
class RepositoriesListModel {
  ...
  factory RepositoriesListModel.fromJson(Map<String, dynamic> json) => RepositoriesListModel(
